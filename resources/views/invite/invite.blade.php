            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4 class="text-center mb-3" style="font-weight: 700; color:#000;">Please Enter Details</h4>
                        <form action="{{ route('invite.checkName')}}" method="POST">
                            @csrf
                            {{-- <input type="hidden" id="candidates" name="candidates" value="{{ session('userId') }}" > --}}
                            {{-- <input type="hidden" id="tocken" name="token" value="{{$token}}" > --}}
    ...
    <div class="bg-primary pt-4 pb-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="assessment-title text-center">
                       <a href="{{ url('test/'. $token) }}" class="btn btn-default">Start Test</a>
                    </div>
                </div>
            </div>
        </div>
